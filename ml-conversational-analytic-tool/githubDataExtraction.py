...
class GithubDataExtractor:
    ...
    def getAllPulls(self, reaction_flag=False):
        ...
        if self.repo_opened:  # Verify if a repo has been opened
            ...
            return pd.DataFrame(pull_data)  # Convert list of dictionaries to dataframe
...
if __name__ == "__main__":
    ...
    file_name = utils.construct_file_name(args.name, args.organization, args.reponame)
